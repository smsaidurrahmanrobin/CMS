...
//    echo   $checkBoxValue;
     ...
     $bulk_options = $_POST['bulk_options'];
       ...
       switch($bulk_options){
           ...
           $query = "UPDATE post SET post_status ='{$bulk_options}' WHERE post_id = {$checkBoxPostId}";
           ...
           break;
            ...
            $update_post_status_unpublished = mysqli_query($connection,$query);
            ...
            $query = "DELETE FROM post WHERE post_id = {$checkBoxPostId}";

            $update_post_to_delete = mysqli_query($connection,$query);
            ...
            $query = "SELECT * FROM post WHERE post_id = {$checkBoxPostId}";
         ...
         die("'copy_post_query' Failed !!" . mysqli_error($connection));
         }       
...
?>
   ...
   <form method="post">
    ...
    echo "<td><input class='btn btn-danger' type='submit' name='delete' value='Delet' onClick=\"javascript: return confirm('Do you really want to delete?';) \"></td>";
...
?>  
 <?php 
    ...
    echo "<ecript>alert('you do not have access')</script>";
